"""Source-as-corruption discrete diffusion for translation.

Forward process: gradually replace German target tokens with English source tokens.
At t=T the sequence is the English input. At t=0 it is the German target.
Where source is shorter than target, [MASK] is used as fallback noise.
