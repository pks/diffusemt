...
class Config:
    ...
    # Training — v33: reduced batch for unfrozen embedding gradient memory (~1GB extra)
    batch_size: int = 36
    ...
    val_every: int = 2500
    save_every: int = 5000
    checkpoint_dir: str = "checkpoints_v33"
    grad_clip: float = 0.5
